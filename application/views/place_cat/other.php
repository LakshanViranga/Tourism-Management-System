    ...
    <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
            <div class="col-md-10 text-center" data-aos="fade">
                <h1 class="heading mb-3">Best Shopping Place to Buy</h1>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 post mb-5" data-aos="fade-up" data-aos-delay="100">
                    <div class="media media-custom d-block mb-4 h-100">
                        ...
                        <div class="media-body">
                            <h2 class="mt-0 mb-3"><a href="#"><?php echo $row->name ?></a></h2>
                            <p>Location Description</p>
                            <a href="<?php echo base_url('index.php/Place_Controller/P_Other2/'.$row->id);?>"class="btn btn-primary text-white py-2 mr-3" style="align:center">More Details..</a>
                        </div>
                    </div>
                </div>
            <?php endforeach;?>
