                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 post mb-5" data-aos="fade-up" data-aos-delay="100">
                    <div class="media media-custom d-block mb-4 h-100">
                        ...
                        <div class="media-body">
                            ...
                            <a href="<?php echo base_url('index.php/Place_Controller/P_Restaurants2/'.$row->id);?>"class="btn btn-primary text-white py-2 mr-3" style="align:center">More Details..</a>
                        </div>
                    </div>
                </div>
            <?php endforeach;?>
